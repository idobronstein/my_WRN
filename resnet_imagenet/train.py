...
def train():
    ...
    with tf.Graph().as_default():
        ...
        for step in range(init_step, FLAGS.max_steps):
            ...
            _, lr_value, loss_value, acc_value, train_summary_str, logits, o_g0, o_g1, o_g2, o_g3, = \
                    sess.run([network.train_op, network.lr, network.loss, network.acc, train_summary_op, network._logits ,network.o_g0, network.o_g1, network.o_g2, network.o_g3],
